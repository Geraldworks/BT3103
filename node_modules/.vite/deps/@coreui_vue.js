...
var File = typeof window !== "undefined" ? window.File : class File2 extends Object {
};
...
function j(e, t2) {
  const n2 = Object.defineProperties(t2, { _vueTypes_name: { value: e, writable: true }, isRequired: { get() {
    ...
    return void 0 === e2 ? this.type === Boolean || Array.isArray(this.type) && this.type.includes(Boolean) ? void (this.default = void 0) : (p(this, "default") && delete this.default, this) : h2(e2) || true === m(this, e2, true) ? (this.default = v(e2) ? () => [...e2] : c(e2) ? () => Object.assign({}, e2) : e2, this) : (f(`${this._vueTypes_name} - invalid default value: "${e2}"`), this);
  } } }), { validator: r2 } = n2;
...
function _(e, t2) {
  ...
  return Object.defineProperty(n2, "validate", { value(e2) {
    return h2(this.validator) && f(`${this._vueTypes_name} - calling .validate() will overwrite the current custom validator function. Validator info:
