...
var CChart = defineComponent({
  ...
  setup(props, { emit, slots }) {
    const canvasRef = ref();
    let chart;
    const computedData = computed(() => typeof props.data === "function" ? canvasRef.value ? props.data(canvasRef.value) : { datasets: [] } : merge_1({}, props.data));
    const renderChart = () => {
      if (!canvasRef.value)
        return;
      ...
      chart = new auto_default(canvasRef.value, {
        type: props.type,
